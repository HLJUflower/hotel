        ...
        <form action="${ctx}/Passenger/update.do" method="post" onsubmit="return verify()">
            ...
            <div class="span12">
                <div class="row-fluid">
                        ...
                        <select name="genderID" style="width:100%;height:26px;">
                            <c:forEach items="${listGender}" var="item">
                                <option value="${item.far_id}"
                                        <c:if test="${item.far_id==list.genderID}">selected="selected"</c:if>>
                    ...
                    <div class="span3">
                        <label>出生日期：</label>
                        <input id="birthDateId" name="birthDate" type="text" style="width:100%;height:26px;"
                               placeholder="年-月-日" value="${list.birthDate}">
                    </div>
                    <div class="span3">
                        <label>民族：</label>
                        <select name="nationID" style="width:100%;height:26px;">
                            <c:forEach items="${listNation}" var="item">
                                <option value="${item.far_id}"
                                        <c:if test="${item.far_id==list.nationID}">selected="selected"</c:if>>
                                        ${item.attributeDetailsName}
                                </option>
                            </c:forEach>
                        </select>
            ...
            <div class="span12">
                <div class="row-fluid">
                    <div class="span3">
                        <label>发证机关：</label>
                        <input name="licenceIssuingAuthorty" type="text" style="width:100%;height:26px;"
                               value="${list.licenceIssuingAuthorty}">
                    </div>
                    <div class="span3">
                        <label>证件有效期：</label>
                        <input name="papersValidity" type="text" style="width:100%;height:26px;"
                               placeholder="年-月-日 至 年-月-日" value="${list.papersValidity}">
                    </div>
                    <div class="span3">
                        <label>职业：</label>
                    ...
                    <div class="span3">
                        ...
                        <select name="educationDegreeID" style="width:100%;height:26px;">
                            <c:forEach items="${listEducationDegree}" var="item">
                                <option value="${item.far_id}"
                                        <c:if test="${item.far_id==list.educationDegreeID}">selected="selected"</c:if>>
                                        ${item.attributeDetailsName}
                                </option>
                            </c:forEach>
                        </select>
            ...
            <div class="span12">
                <div class="row-fluid">
                    <div class="span3">
                        ...
                        <select name="passengerLevelID" style="width:100%;height:26px;">
                            <c:forEach items="${listPassengerLevel}" var="item">
                                <option value="${item.far_id}"
                                        <c:if test="${item.far_id==list.passengerLevelID}">selected="selected"</c:if>>
                                        ${item.attributeDetailsName}
                                </option>
                            </c:forEach>
                        </select>
                    ...
                    <div class="span3">
                        ...
                        <select id="papersId" name="papersID" style="width:100%;height:26px;">
                            <c:forEach items="${listPapers}" var="item">
                                <option value="${item.far_id}"
                                        <c:if test="${item.far_id==list.papersID}">selected="selected"</c:if>>
                                        ${item.attributeDetailsName}
                                </option>
                            </c:forEach>
                        </select>
                    ...
                    <div class="span3">
                        <label>单位或住址：</label>
                        <input name="unitsOrAddress" type="text" style="width:100%;height:26px;"
            ...
            <div class="span12">
                <div class="row-fluid">
                    <div class="span3">
                        ...
                        <select name="thingReasonID" style="width:100%;height:26px;">
                            <c:forEach items="${listThingReason}" var="item">
                                <option value="${item.far_id}"
                                        <c:if test="${item.far_id==list.thingReasonID}">selected="selected"</c:if>>
                                        ${item.attributeDetailsName}
                                </option>
                            </c:forEach>
                        </select>
                    ...
                    <div class="span3">
                        <label>从何处来：</label>
                        <input name="whereAreFrom" type="text" style="width:100%;height:26px;"
                               value="${list.whereAreFrom}">
                    </div>
                    <div class="span3">
                        <label>到哪里去：</label>
