...
<script type="text/javascript">
    ...
    var option = {
        ...
        legend: {
            ...
            data: ['${bigRoom}-${count1}', '${oneRoom}-${count2}', '${twoRoom}-${count3}', '${twoRoom2}-${count4}', '${bigRoom2}-${count5}', '${twoRoom3}-${count6}',
                '${yuGang}-${count7}', '${movieRoom}-${count8}', '${meetingRoom}-${count9}', '${bestRoom}-${count10}'],
            textStyle: {    //图例文字的样式
                color: '#8d1020',  //文字颜色
                fontSize: 18    //文字大小
            }
        ...
        series: [
            {
                ...
                radius: ['30%', '60%'],//饼图的半径，数组的第一项是内半径，第二项是外半径。[ default: [0, '75%'] ]
                ...
                data: [
                    ...
                    {
                        value:${ratio4},
                        name: '${twoRoom2}-${count4}'
                    }, {
                        value:${ratio5},
                        name: '${bigRoom2}-${count5}'
                    }, {
                        value:${ratio6},
                        name: '${twoRoom3}-${count6}'
                    }, {
                        value:${ratio7},
                        name: '${yuGang}-${count7}'
                    }, {
                        value:${ratio8},
                        name: '${movieRoom}-${count8}'
                    }, {
                        value:${ratio9},
                        name: '${meetingRoom}-${count9}'
                    },
                    {
                        value:${ratio10},
                        name: '${bestRoom}-${count10}'
                    }
                ]
            }
        ]
