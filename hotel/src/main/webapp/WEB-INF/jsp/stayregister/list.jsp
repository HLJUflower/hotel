            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab1">
                    ...
                    <form action="" method="post" style="width:18%;float: left;">
                        <input id="txtnameid" name="txtname" class="roomnumberwidth"
                        ...
                        <div class="input-append">
                            <button onclick="selectfunction()" type="button" class="btn-success"
                    ...
                    <button class="btn btn-info btn-small" type="button" onclick="changroomfunction()">
                        <li class="icon-refresh icon-white"></li>
                        换房
                    </button>
                    <button class="btn btn-info btn-small" type="button" onclick="depositfunction()">
                        <li class="icon-eye-open icon-white"></li>
                        押金记录
                    </button>
                    <button class="btn btn-info btn-small" type="button" onclick="consumptionfunction()">
                        <li class="icon-gift icon-white"></li>
                        旅客消费
                    </button>
                    <button class="btn btn-info btn-small" type="button" onclick="payfunction()">
                        <li class="icon-heart icon-white"></li>
                        结账
                    </button>
                    <button class="btn btn-info btn-small" type="button" onclick="shiftteamfunction()">
                        <li class="icon-refresh icon-white"></li>
                        转入团队 / 房间信息
                    </button>
                </div>
                        ...
                        <div class="row-fluid">
                            <div class="span2">
                                ...
                                <input id="teamNameId" class="widthone" style="height: 25px;" type="text"
                                       readonly="readonly" value="${teamNameId}">
                            </div>
                            <div class="span2">
                                <label>团队编号：</label>
                                <input id="teamCodeId" class="widthone" style="height: 25px;" type="text"
                                       readonly="readonly" value="${teamCodeId}">
                            </div>
                            <div class="span2">
                                <label>负责人：</label>
                                <input id="principalId" class="widthone" style="height: 25px;" type="text"
                                       readonly="readonly" value="${principalId}">
                            </div>
                            <div class="span2">
                                <label>联系电话：</label>
                                <input id="contactPhoneNUmberId" class="widthone" style="height: 25px;" type="text"
                                       readonly="readonly" value="${contactPhoneNUmberId}">
                            </div>
                            <div class="span2">
                                <label>登记时间：</label>
                                <input id="registerTimeId" class="widthone" style="height: 25px;" type="text"
                                       readonly="readonly" value="${registerTimeId}">
                            </div>
                            <div class="span2">
                                <label>总费用：</label>
                                <input id="sumConstId" class="widthone" style="height: 25px;" type="text"
                                       readonly="readonly" value="${teamSumConst}">
                            </div>
                        </div>
                    </div>
                    <div class="span12" style="margin-left:0px;">
                        <div class="row-fluid">
                            ...
                            <form action="" method="post" style="width:16%; float: left;">
                                <input id="roomNumberId" class="roomnumberwidth"
                                       style="border-radius:0px; border-top-left-radius:4px; border-bottom-left-radius:4px;height:26px;"
                                       type="text" placeholder="请输入关键字" value="${txtname}">
                                <div class="input-append">
                                    <button onclick="teamSelect()" type="button" class="btn-success"
                                            style="margin-left:-4px;height:26px;">
                                        <li class="icon-search icon-white"></li>
                                        查询
                                    </button>
                            ...
                            <a href="#duixiang" data-toggle="modal" class="btn btn-info btn-small"
                               onclick="selectTarget()">
                                <li class="icon-plus icon-white"></li>
                                选择对象</a>
                            <button class="btn btn-info btn-small" type="button" onclick="teamRegisterfunction()">
                                <li class="icon-plus icon-white"></li>
                                登记
                            </button>
                            ...
                            <button class="btn btn-info btn-small" type="button" onclick="volumeroomfunction()">
                                <li class="icon-plus icon-white"></li>
                                批量安排房间
                            </button>
                            ...
                            <button class="btn btn-info btn-small" type="button" onclick="teamDepositfunction()">
                                <li class="icon-eye-open icon-white"></li>
                                押金记录
                            </button>
                            ...
                            <button class="btn btn-info btn-small" type="button" onclick="teampayfunction()">
                                <li class="icon-heart icon-white"></li>
                                结账
                            </button>
                            <button class="btn btn-info btn-small" type="button" onclick="shiftpersonagefunction()">
                                <li class="icon-refresh icon-white"></li>
                                转为散客
                            </button>
                        </div>
        ...
        <div class="span5" style="width:98%;height:480px; overflow-x:auto;">
            <div class="row-fluid">
                <div class="span8">
                    ...
                    <input name="txtname" class="textone"
                           style="width:60%; border-radius:0px; border-top-left-radius:4px; border-bottom-left-radius:4px;height:26px;"
                           type="text" placeholder="请输入关键字" value="${txtname}">
                    <div class="input-append">
...
<script type="text/javascript">
    ...
    function registerfunction() {
        ...
        $('input[name="id"]:checked').each(function () {
            ...
            TOF = table.rows[selectedIndex - 1].cells[14].innerHTML;
        });
        if (TOF == 69) {
        ...
        /* parent.document.getElementById('Mainid').src='

        ${ctx}/StayRegister/toregister.do'; */
    }
    ...
    function consumptionfunction() {
        ...
        $('input[name="id"]:checked').each(function () {
            ...
            lvKeName = table.rows[selectedIndex - 1].cells[5].innerHTML;
            roomNumber = table.rows[selectedIndex - 1].cells[1].innerHTML;
            TOF = table.rows[selectedIndex - 1].cells[14].innerHTML;//获取是否结账的节点
        });
        if (chk_value != "") {
            if (chk_value.toString().indexOf(",") > 0) {
                alert("只能选择一个房间添加消费哦");
    ...
    function shiftpersonagefunction() {
        ...
        if (id != "") {
            if (id.toString().indexOf(",") > 0) {
                ...
                parent.document.getElementById('Mainid').src = '${ctx}/StayRegister/toshiftpersonage.do?id=' + id[0] +
    ...
    function shiftteamfunction() {
        ...
        if (id != "") {
            if (id.toString().indexOf(",") > 0) {
                ...
                parent.document.getElementById('Mainid').src = '${ctx}/StayRegister/toshiftteam.do?id=' + id[0] +
                    '&stayregisterdetailsId=' + stayregisterdetailsId;
            }
        } else {
            alert("请选择一条数据进行转入团队");
    ...
    function confirmRarget() {
        ...
        ${ctx}/StayRegister/ajaxSelectTeamSumcont.do',   //地址 type 带参数
