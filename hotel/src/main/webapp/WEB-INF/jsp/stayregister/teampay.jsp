                        ...
                        <select id="payWay" style="width:70%;height:27px;">
                            <c:forEach items="${listPayWay}" var="item">
                                <option value="${item.far_id}"
                                        <c:if test="${item.far_id==22}">selected="selected"</c:if>>
            ...
            <div class="span12">
                <div class="row-fluid">
                    <div class="span8">
                        ...
                        <input style="width:32%;height:27px;" type="text"
                               onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}'})" id="datemin"
                               class="input-text Wdate"> 一
                        <!--最大日期为当前系统日期，最小日期为id="datemin选中值"-->
                        <input style="width:33%;height:27px;" type="text"
                               onfocus="WdatePicker({minDate:'#F{$dp.$D(\'datemin\')}',maxDate:'%y-%M-%d'})"
                               id="datemax" class="input-text Wdate">
                        <button onclick="timeAjaxSelectRoom()" type="button" class="btn-success"
