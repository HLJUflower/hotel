                        ...
                        <select name="roomStateID" class="cboone inputone">
                            <c:forEach items="${listTwo}" var="item">
                                <option value="${item.far_id}"
                                        <c:if test="${item.far_id==1}">selected="selected"</c:if>>
            ...
            <div class="span12 margin-top-one">
                <div class="row-fluid">
                    <div class="span5">
                        ...
                        <input id="roomAmountId" name="roomAmount" class="textone inputone" style="height:26px;"
                               type="text" onblur="onchangeOne()">
                        <div id="divTwo">
                            <label class="yansered" style="margin-top:18px;">*</label>
                        </div>
                    </div>
                    <div class="span5">
                        ...
                        <select name="guestRoomLevelID" class="cboone inputone">
                            <c:forEach items="${listOne}" var="item">
                                <option value="${item.far_id}"
                                        <c:if test="${item.far_id==8}">selected="selected"</c:if>>
                                        ${item.attributeDetailsName}
                                </option>
                            </c:forEach>
                        </select>
