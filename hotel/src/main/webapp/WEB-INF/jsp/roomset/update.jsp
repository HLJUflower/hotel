                        ...
                        <select name="roomStateID" class="cboone inputone">
                            <c:forEach items="${listTwo}" var="item">
                                <option value="${item.far_id}"
                                        <c:if test="${item.far_id==listPo.roomStateID}">selected="selected"</c:if>>
                    ...
                    <div class="span5">
                        ...
                        <select name="guestRoomLevelID" class="cboone inputone">
                            <c:forEach items="${listOne}" var="item">
                                <option value="${item.far_id}"
                                        <c:if test="${item.far_id==listPo.guestRoomLevelID}">selected="selected"</c:if>>
                                        ${item.attributeDetailsName}
                                </option>
                            </c:forEach>
                        </select>
            ...
            <div class="span12 margin-top-one">
                <div class="row-fluid">
                    ...
                    <div class="span6">
                        ...
                        <input id="standardPriceDayId" name="standardPriceDay" class="textone inputtwo radiusone"
                               onblur="onchangeOne()" value="${listPo.standardPriceDay}"
                               style="float:left;border-radius:0px; border-top-right-radius:4px; border-bottom-right-radius:4px; height:26px;"
                               type="text">
            ...
            <div class="span12 margin-top-two">
                <div class="row-fluid">
                    <div class="span5">
                        ...
                        <input id="standardPriceId" name="standardPrice" class="textone inputthree radiusone"
                               onblur="onchangeOne()" value="${listPo.standardPrice}"
                               style="float:left;border-radius:0px; border-top-right-radius:4px; border-bottom-right-radius:4px; height:26px;"
                               type="text">
                    ...
                    <div class="span5">
                        ...
                        <input id="maxDurationId" name="maxDuration" class="textone inputthree radiusone"
                               onblur="onchangeOne()" value="${listPo.maxDuration}"
                               style="float:left;border-radius:0px; border-top-right-radius:4px; border-bottom-right-radius:4px; height:26px;"
                               type="text">
            ...
            <div class="span12 margin-top-one">
                <div class="row-fluid">
                    <div class="span5">
                        ...
                        <input id="firstPriceId" name="firstPrice" class="textone inputthree radiusone"
                               onblur="onchangeOne()" value="${listPo.firstPrice}"
                               style="float:left;border-radius:0px; border-top-right-radius:4px; border-bottom-right-radius:4px; height:26px;"
                               type="text">
                    ...
                    <div class="span5">
                        ...
                        <input id="firstDurationId" name="firstDuration" class="textone inputthree radiusone"
                               onblur="onchangeOne()" value="${listPo.firstDuration}"
                               style="float:left;border-radius:0px; border-top-right-radius:4px; border-bottom-right-radius:4px; height:26px;"
                               type="text">
