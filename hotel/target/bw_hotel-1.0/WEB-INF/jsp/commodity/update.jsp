                        ...
                        <select name="commodityTypeID" class="cboone inputone">
                            <c:forEach items="${listTwo}" var="item">
                                <option value="${item.far_id}"
                                        <c:if test="${item.far_id==listPo.commodityTypeID}">selected="selected"</c:if>>
            ...
            <div class="span12">
                <div class="row-fluid">
                    <div class="span5">
                        ...
                        <input id="salePriceId" name="salePrice" class="textone inputthree radiusone"
                               onchange="onchangeOne()" value="${listPo.salePrice}"
                    ...
                    <div class="span5">
                        ...
                        <select name="uOMID" class="cboone inputone">
                            <c:forEach items="${listOne}" var="item">
                                <option value="${item.far_id}"
                                        <c:if test="${item.far_id==listPo.uOMID}">selected="selected"</c:if>>
                                        ${item.attributeDetailsName}
                                </option>
                            </c:forEach>
                        </select>
