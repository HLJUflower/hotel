...
<div class="container">
    ...
    <div class="span11" style="height:610px;; border: solid; border-color: #DDDDDD;">
        ...
        <div class="span4" style="text-align:center;">
            <div class="row-fluid">
                <button class="btn btn-danger textone" type="button" onclick="deletefunction()">
            ...
            <div class="span5" style="width:98%;height:480px; overflow-x:auto;">
                <div class="row-fluid">
                    <div class="span6">
                        ...
                        <input id="txtnameid" class="textone"
                               style="width:40%; border-radius:0px; border-top-left-radius:4px; border-bottom-left-radius:4px;height:27px;"
                               type="text" placeholder="请输入关键字" value="${txtname}">
                        <div class="input-append">
                            <button onclick="ajaxSelect()" type="button" class="btn-success textone"
                                    style="margin-left:-4px;height:27px;">
                        ...
                        <select id="selectCboId" style="margin-top:10px;width:100%;" onchange=ajaxSelect()>
                            <c:forEach items="${listOne}" var="item">
                                <option value="${item.far_id}"
                                        <c:if test="${item.far_id==16&&item.far_id!=76}">selected="selected"</c:if>>
                    ...
                    <div class="span3" style="text-align: left;">
                        <button id="btn1" class="btn btn-info btn-small textone" data-dismiss="modal" type="button"
