...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">管理员新增</h3>
        
      </div>
    </div>
    
    <form action="${ctx}/users/add.do" method="post" onsubmit="return verify()">
    <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span3">
				 用户名：<input id="nameId" name="username" type="text" style="width:97%;height:27px;float: left" onchange="onchangeOne()" onblur="YZ(this.value)"/>
	    ...
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span3">
				 密码： <input id="pwd" name="password" type="password" style="width:97%;height:27px;float: left" onchange="onchangeOne()"/>
	    ...
	    <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
	     <div class="span12">
	      <div class="row-fluid">
		     <div class="span3">
				 确认密码：<input id="repwd" name="repassword" type="password" style="width:97%;height:27px;float: left"onchange="onchangeOne()" />
