...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" >
    ...
    <div class="span6">
      <div class="row-fluid">
       <%--<div class="span3">
         <button class="btn btn-info btn-small textone" type="button" disabled onclick="addfunction()"><li class="icon-plus icon-white"></li>新增</button>
       </div>--%>
       <div class="span3">
       ...
       <%--<div class="span3">
         <button class="btn btn-danger btn-small textone" type="button" disabled onclick="deletefunction()"><li class="icon-remove icon-white"></li>删除</button>
       </div>--%>
      </div>
    </div>
    <br>
