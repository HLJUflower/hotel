                        ...
                        <select name="targetTypeID" class="cboone inputone">
                            <c:forEach items="${listOne}" var="item">
                                <option value="${item.far_id}"
                                        <c:if test="${item.far_id==list.targetTypeID}">selected="selected"</c:if>>
            ...
            <div class="span12">
                <div class="row-fluid">
                    <div class="span5">
                        ...
                        <input id="registerTimeId" name="registerTime" class="textone inputone" style="height:26px;"
                               id="date" class="Wdate" type="text" value="${list.registerTime}"
